...
\begin{description}
    ...
    Please note that this way of specifying snapshots differs from the internal structure, explained in \todo{ref}. We did this, since customers might find it easier to specify the delay between measurements and samples, rather than having to calculate the different frequencies. 
...
\todo[inline]{Har overvejet om vi skal indsætte et ``code snippet'' der viser hvordan JSON'en ser ud, men det bliver hurtigt langt og kedeligt. Men det er det måske ikke, hvis man aldrig har set det før?}

\todo[inline]{Man kan beregne alle mulige statistikker som kan hjælpe kunderne med at lave gode spørgsmål, ved eksempelvis at vise hvilke spørgsmål der bliver besvaret mest, eller i hvilke tidsrum de bliver svaret med på i} 
...
\todo[inline]{Beskriv hvordan man sletter en campaign (når @clausen har implementeret det)}