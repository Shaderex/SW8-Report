...
\begin{description}
    ...
    Please note that this way of specifying snapshots differs from the internal structure, explained in \secref{sec:structural_sensor_data}. We did this, since customers might find it easier to specify the delay between measurements and samples, rather than having to calculate the different frequencies. 
...
\todo[inline, color=green]{Til Rikke: Synes du vi skal indsætte et eksempel på hvordan JSON'en kunne se ud her?}
