...
\todo[inline]{Skriv om hvordan TDD hjalp os og hvordan vi mere og mere brugte manuelle tests}

\todo[inline]{Skriv om at vi brugte for lang tid på at sætte continious integration op? Har vi nogle solstråle historier? ``Man bygger ikke ovenpå ting der fejler''}

\todo[inline]{
Er der noget vigtigt at sige om dokumentation? Hængeparti med dokumentation
}
