...
\section{Server}
\label{sec:server}
The server, seen in the top right part of \secref{fig:system_architecture}, provides a Graphical User Interface (GUI) for the customers, and an Application Programming Interface (API) for the communication between the device and the server.
\\\\
