...
Due to the structure of sensor providers, as described in \secref{sub:providing_sensor_data_implementation}, it is relativly easy to implement functionality that will gather information from the Microsoft Band 2 smart watch. 