...
\todo[inline]{Beskriv at dette kode er stjålet}

\todo[inline]{Beskriv koden i detajker. Hvorfor log? Hvorfor devices[0]? osv}

\lstinputlisting[
   style = Java,
   caption = {Establishing a connection between the Android application and the Microsoft Band 2.},
