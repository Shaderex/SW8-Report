...
Note that other type of sensors such as GPS is, as mentioned in \secref{sec:deriving_the_context_from_sensors}, required on demand meaning that we are able to require the GPS location at any given time and here the only problem is the latency of which the underlying operating system has before sensor of this type is returned to the caller.
