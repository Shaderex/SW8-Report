...
\todo[inline]{Beskriv, at med disse metoder, vil den abstrakte klasse være i stand til at tage de nødvendige målinger, have sin egen cache osv. Så slipper vi for redundant kode! Beskriv interfaces af sensorprovider klassen, og beskriv hvordan vi genererer samples og lav en reference til hvordan et sample er bygget op}
