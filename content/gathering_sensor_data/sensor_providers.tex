...
We have implemented an abstract class called \mono{SensoProvider}, which can be specialized for each type of sensor available. The common interface for these sensor providers is implemented by the following methods:
