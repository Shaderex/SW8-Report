...
We have designed a general abstraction for the different available sensors and data sources to support the structure as described in \secref{sec:structural_sensor_data} called a \emph{Sensor Provider}. 
\\\\
...
\begin{description}
  ...
  \item[\mono{FloatTripleMeasurement getDefaultMeasurement()}] Should return a default instance of the \mono{MeasurementT} that the subclass is parameterized with.
...
\todo{Marhlder er nået her til - Der er lidt duplicate tekst her}
