...
\\\\
This role-playing, at least from a customer perspective, is guided by a vision of the system as developed using methods from Essense, see \charef{cha:vision}.
...
Our requirements will be modeled through the user stories and tests, including the acceptance tests, unit tests, and any other formal testing. The requirments are not static in our development process and they are constantly undergoing iteration and refinement. We will however summarize our functional and non-functional requirements, as they looked towards the end of the development for this project, for the purpose of documenting them in the report in a dedicated section. The user stories and acceptance test are documented in \appref{app:user_stories_and_acceptance_test} and our unit and functional tests can be found in \appref{app:cd}.

\todo{Check at det her bliver gjort og overvej om man skal have ref til der hvor de rent faktisk står} 
