...
Our requirements will be modeled through the user stories and tests, including the acceptance tests, unit tests, and any other formal testing. The requirments are not static in our development process and they are constantly undergoing iteration and refinement. We will however summarize the requirements, as they looked towards the end of the development for this project, for the purpose of documenting them in the report in a dedicated section. The user stories and acceptance test are documented in \appref{app:user_stories_and_acceptance_test} and our unit and functional tests can be found in \appref{app:cd}.
