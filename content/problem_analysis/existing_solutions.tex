...
\todo[inline]{Vi er ikke helt sikre på om vi må bruge billederne, hvad gør vi?}
% BILLEDER
...
\end{figure}
\FloatBarrier
\footnotetext{http://research.cens.ucla.edu/people/estrin/resources/conferences/2010-oct-wireless-health.pdf}
...
\end{figure}
\FloatBarrier
\footnotetext{https://play.google.com/store/apps/details?id=edu.northwestern.cbits.purple\_robot\_manager}
...
\end{figure}
\FloatBarrier
\footnotetext{https://itunes.apple.com/us/app/sensor-data/id397619802?mt=8}
