...
As mentioned in \secref{sub:essence_vision_scenarios} a suggestion made in Essence is to utilize vision scenarios. For this reason we have come up with a list of opposing lines of development, which can be used to explore the different quadrants of a graph with two of the opposites as its axes.
