...
\begin{itemize}[itemsep=0.1em]
	...
	\item Static/Customizable - Should we require that customers must customize campaigns or should it be ``one data collection configuration fits all''? % 3
...
We have chosen to include Static/Customizable because we thought it would be interesting to explore different ways of allowing customers to configure what data they want and how they want it. % We have chosen Assigned/Opt-in because we were really did
...
\input{content/problem_analysis/objects_events_and_qualities_tables}
