...
\begin{table}[!htbp]
    ...
    \textbf{Smartphones} & \rot{Accelerometer} & \rot{Ambient Light} & \rot{Barometer} & \rot{Cellular Network} & \rot{Magnetometer} & \rot{Galvanic Skin Response$~$} & \rot{Global Positioning} & \rot{Gyroscope} & \rot{Optical Heart Rate} & \rot{Proximity} & \rot{Skin Temperature} & \rot{Ultra Violet} & \rot{Wi-Fi} 
    \\ \hline
